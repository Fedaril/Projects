...
private:
	Gfx::InputLayout*				m_pInputLayout;
	Gfx::VertexBuffer*				m_pTileVertexBuffer;
	Gfx::IndexBuffer*				m_pTileIndexBuffer;

	Gfx::VertexShader*				m_pVertexShader;
	Gfx::PixelShader*				m_pPixelShader;

	Gfx::Texture*					m_pTexture[s_iMaxTextureCount];
	Gfx::Texture*					m_pIndirectMap;

	Gfx::ConstantBuffer*			m_pConstantBuffer;
	Gfx::ConstantBuffer*			m_pConstantBufferTextureScale;
