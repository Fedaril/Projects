...
#include "MatConvSolverApp.h"
#include "TerrainMaterialCSP.h"

MatConvSolverApp g_App;


MatConvSolverApp::MatConvSolverApp()
: MicroSDK::Application(MicroSDK::ApplicationType_Console)
{
}

using namespace MicroSDK;

eSMaterialData* MatConvSolverApp::GetTerrainDataAt( eSMaterialData * a_pData, unsigned int a_iWidth, unsigned int a_iHeight, unsigned int a_iX, unsigned int a_iY)
{
...
unsigned int MatConvSolverApp::CropColumn( eSMaterialData * a_pData, unsigned int a_iWidth, unsigned int a_iHeight, unsigned int a_iStart, unsigned int a_iStep )
{
...
unsigned int MatConvSolverApp::CropRow( eSMaterialData * a_pData, unsigned int a_iWidth, unsigned int a_iHeight, unsigned int a_iStart, unsigned int a_iStep )
{
...
void MatConvSolverApp::CropHeightmap(eSMaterialData * a_pData, unsigned int a_iWidth, unsigned int a_iHeight)
{
...
eSMaterialConvertionData* MatConvSolverApp::CreateFromXinfo(const char* a_sXinfoFile, unsigned int a_iTestStartX, unsigned int a_iTestStartY, unsigned int a_iTestSizeX, unsigned int a_iTestSizeY)
{
	void* pData = NULL;
...
eSMaterialConvertionData* MatConvSolverApp::CreateFromConvData(const char* a_sConvDataFile, unsigned int a_iTestStartX, unsigned int a_iTestStartY, unsigned int a_iTestSizeX, unsigned int a_iTestSizeY)
{
...
void MatConvSolverApp::GatherHmapData(eSMaterialConvertionData* a_pDstData, eSMaterialData* a_pData, unsigned int iHmapX, unsigned int iHmapY)
{
...
eSMaterialConvertionData* MatConvSolverApp::CreateFromHmapData(const char* a_sHmapFile, unsigned int a_iHmapWidth, unsigned int a_iHmapHeight, unsigned int a_iTestStartX, unsigned int a_iTestStartY, unsigned int a_iTestSizeX, unsigned int a_iTestSizeY)
{
...
void MatConvSolverApp::WriteResult(TerrainMaterialCSP& oCSP, const char* a_szFile)
{
	const void* pBuffer;
...
void MatConvSolverApp::OnInitialize()
{
